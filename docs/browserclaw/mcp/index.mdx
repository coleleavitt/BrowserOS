...
keywords: ["connect agent to BrowserClaw", "BrowserClaw MCP", "browser MCP server", "Streamable HTTP MCP", "Claude Desktop MCP"]
---
...
<CardGroup cols={2}>
  <Card title="Claude Desktop and Cowork" icon="messages" href="/browserclaw/mcp/claude-desktop">
    Install the BrowserClaw extension into Claude Desktop with a single file.
  </Card>
