...
keywords: ["BrowserClaw setup", "connect AI to browser", "how BrowserClaw works", "AI browser walkthrough"]
---
...
<Steps>
  <Step title="Install BrowserClaw">
    Head over to [browseros.com/agents](https://browseros.com/agents) and download BrowserClaw for your operating system. Install it the way you'd install any other browser.
  ...
  <Step title="Sign in like you normally would">
    Use BrowserClaw as your browser for a bit. Sign in to Gmail. Sign in to your calendar. Sign in to Notion, Linear, your CRM, your accounting tool, whatever you use for actual work.
  ...
  <Step title="Connect BrowserClaw to your AI">
    ...
    <Frame caption="The connect page: one endpoint, one click per AI tool.">
      <img src="/images/browserclaw--mcp-install-board.png" alt="BrowserClaw connect page showing an endpoint URL at the top and six AI tools listed underneath: Claude Code, Codex, Cursor, Antigravity, VS Code, and Zed. Each has a Connect button on the right." />
    </Frame>

    Find the AI tool you use: Claude Code, Cursor, Codex, Antigravity, VS Code, Zed, or another. Click **Connect** on its row. BrowserClaw sets everything up for you.
  ...
  <Step title="Watch it work">
    ...
    <Frame caption="Every running AI and every finished session, at a glance.">
      <img src="/images/browserclaw--dashboard-populated.png" alt="BrowserClaw new-tab dashboard with a large italic headline reading 'What are your agents working on right now?' A row of Running now cards shows a live agent session with a live browser preview. Below it, a grid of Recent activity tiles shows five completed sessions with the sites they visited." />
    </Frame>
  ...
  <Step title="Replay what your AI did">
    ...
    <Frame caption="Replay any session like a video. Scrub through, see exactly what your AI saw at every moment.">
      <img src="/images/browserclaw--replay-scrubber.png" alt="BrowserClaw replay screen showing a full-fidelity playback of a page the AI browsed. A play/pause scrubber sits at the bottom. On the right, an action timeline lists every step the AI took, synced to the current moment in the video." />
    </Frame>
