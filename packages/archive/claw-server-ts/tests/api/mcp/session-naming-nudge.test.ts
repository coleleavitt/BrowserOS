...
import type { ToolCall } from '../../../src/api/mcp/dispatch'
import { applySessionNaming } from '../../../src/api/mcp/effects/session-naming'
import type { ToolResult } from '../../../src/api/mcp/register-fn'
import {
